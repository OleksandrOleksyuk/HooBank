  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <div className="flex justify-between items-center w-full mt-5">
        <h1 className="capitalize text-white md:text-7xl text-5xl font-poppins font-semibold flex-1">
      ...
      <h1 className="capitalize text-white md:text-7xl text-5xl font-poppins font-semibold">
        payment method
      </h1>
